...
## SSH Autentication (GitLab) (Preferred)
...
```bash
git remote set-url origin git@gitlab.com/path/to/your/project.git
```

## Personal Access Token
The git origin url always defines the authentication method
```bash
git remote set-url origin https://<username>:<personal_token>@gitlab.com/gitlab-org/gitlab.git
```
